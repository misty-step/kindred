...
**Installed source: `vendor/parlor` at `f43a8d16704257d83eb621642d9ed818bab12494`.** The reference is copied from that exact commit. Inspect the installed exports and local modifications before using an example; source signatures take precedence over older prose. A copied vendor tree may omit examples or docs mentioned in the reference.
