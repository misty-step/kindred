...
const messages: Record<string, string> = {
  ...
  ROUND_NOT_FOUND: "This question is no longer available.",
  ROUND_NOT_ANSWERING: "This question is not taking answers now.",
  ROUND_NOT_PENDING: "Answers are already in. Wait for the reveal.",
  ROUND_NOT_READY_TO_ADVANCE: "Wait for the reveal before moving on.",
  JUDGE_EXHAUSTED: "Still checking answers. Try again in a minute.",
